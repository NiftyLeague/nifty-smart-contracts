...
export const BASE_DEGENS_URI = (network: NetworkName) => `https://api.niftyleague.com/${network}/degen/metadata/`;
...
// Immutable X
export const IMX_BASE_API = (network: NetworkName) =>
  `https://api.${MAINNET_NETWORKS.includes(network) ? '' : 'sandbox.'}immutable.com/v1`;
