...
const deploy = async (
  ...
  console.log(
    ...
    'deployed to:',
    chalk.magenta(deployedContractAddress)
  )
  ...
  if (contractType == 0) {
    ...
    const implementationAddress =
      await upgrades.erc1967.getImplementationAddress(deployedContractAddress)
...
async function main() {
  ...
  console.log(
    chalk.blue(` 📁 Attempting etherscan verification of ${itemSaleAddress} on ${targetNetwork}`)
  )
